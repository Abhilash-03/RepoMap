...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 dark:focus:ring-slate-300 focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-transparent bg-slate-900 dark:bg-slate-50 text-slate-50 dark:text-slate-900 shadow",
        secondary: "border-transparent bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-slate-100",
